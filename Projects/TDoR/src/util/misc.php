<?php
    ...
    /**
     * Get details of the specified HTTP status code.
     *
     * ref:     https://gist.github.com/phoenixg/5326222
     *
     * @param int $code             The code to look up.
     * @return array                Details of the code and its description.
     */
    function GetHttpStatus($code)
    {
        ...
        return array('code' => $code, 'error' => $http[$code]);
    }
