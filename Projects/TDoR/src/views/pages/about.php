...
<p>The idea for the site came about as a direct result of the experiences of <a href="https://www.annasplace.me.uk/about" target="_blank" rel="noopener">Anna-Jayne Metcalfe</a> while collating information in preparation for the TDoR 2017 vigil in Bournemouth, United Kingdom. Afterwards she wrote the blogpost <a href="https://medium.com/@annajayne/remembering-our-dead-never-gets-any-easier-befb5d7ee7cc" target="_blank" rel="noopener"><b>Remembering Our Dead Never Gets Any Easier</b></a>. Please be warned that it is not an easy read.</p>

<p>Subsequently, what she learned about each of the victims was written up in a series of blogposts (one per month) starting at <a href="https://medium.com/@annajayne/tdor-2017-say-their-names-learn-their-stories-remember-them-b81d50fd8ef" target="_blank" rel="noopener"><b>TDoR 2017: Say their names. Learn their stories. Remember them</b></a>.</p>

<p>Although she also wrote <a href="https://medium.com/@annajayne/tdor-2018-say-their-names-read-their-stories-remember-them-2ccdccc9db1a" target="_blank" rel="noopener"><b>a similar series of blogposts for TDoR 2018</b></a>, the aim was always to develop a dedicated site for this purpose instead.</p>
...
<p>All code and data produced to support this site has been open sourced to ensure that nothing should be lost if anything happens to the site or anyone working on it. Project repositories are available on GitHub at:</p>

<ul>
  <li><a href="https://github.com/annajayne/tdor-site" target="_blank" rel="noopener">https://github.com/annajayne/tdor-site</a> (tdor.translivesmatter.com code)<br>&nbsp;</li>
  <li><a href="https://github.com/annajayne/tdor-data" target="_blank" rel="noopener">https://github.com/annajayne/tdor-data</a> (archive of published data)<br>&nbsp;</li>
  <li><a href="https://github.com/annajayne/tdor-research" target="_blank" rel="noopener">https://github.com/annajayne/tdor-research</a> (wiki containing data on unpublished cases, in <a href="https://zim-wiki.org/" target="_blank" rel="noopener">Zim</a> format)<br>&nbsp;</li>
</ul>

<p>You can also export a snapshot of the data (in a slightly richer CSV format than contained in the raw archives above) directly from the <a href="/reports"><b>Reports</b></a> page.</p>
...
<div align="left">
  <img src="/images/trans_flag.jpg" style="margin:0.5em;" alt="Trans flag" />
</div>

<p>We must never forget that all of this is just a means to an end - that end being an end to transphobic violence and everything that stems from it. We'd also be remiss if we didn't say thank you to all of the activists worldwide who are working to shine a light on the horror and make sure that those we have lost are not forgotten.</p>
