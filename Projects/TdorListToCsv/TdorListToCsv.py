...
class Test_ReportsCsvWriter(unittest.TestCase):
    ...
    def test_get_csv_header(self):
        ...
        self.assertEqual(writer.get_header(),           'Name,Age,Photo,Photo source,Date,TGEU ref,Location,Country,Cause of death,Description,Permalink')
    ...
    def test_get_csv_entry(self):
        ...
        expected_entry  = "Alvari,not reported,,,10/01/2015,10/01/2015/Alvari,Vitoria,Brazil,not reported,\"Alvari was found in advaced decomposing state without any body perforation.\n\nTvT partner organisation Grupo Gay da Bahia & Manchete Digital 01.10.2015\","
